...
// Apply rate limiting only to routes that start with /api
app.use('/api', limiter);
...
// Middleware for reading cookie data from browser into req.cookies
app.use(cookieParser());
// Middleware for reading form data from body into req.body
