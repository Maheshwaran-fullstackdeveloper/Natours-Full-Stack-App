...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var alertMarkup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          stripe = Stripe('pk_test_51BTUDGJAJfZb9HEBwDg86TN1KNprHjkfipXmEDMb0gSCassK5T3ZfxsAbcgKVmAIXF7oZ6ItlZZbXO6idTHE67IM007EwQ4uN3'); // 1) Get checkout session from API
          _context.n = 1;
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // Using await here to wait for the updateSettings to complete before resetting the form fields
            _context.n = 1;
